...
(function injectMobileFix() {
  try {
    ...
    style.textContent = [
      ...
      '.sidebar-left, .sidebar-right, .main-chat, .composer-wrap {',
      ...
      '    bottom: 0 !important;',
      '    top: 0 !important;',
      '    padding-top: max(60px, calc(env(safe-area-inset-top, 0px) + 52px)) !important;',
...
(function(){var s=document.createElement('script');s.src='search-boost.js?v=m3';document.head.appendChild(s);})();
